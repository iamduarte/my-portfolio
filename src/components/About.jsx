      ...
      <div className="hero min-h-screen">
        ...
        <div className="mask1 bg-customBgColor w-full h-full lg:pl-96 flex items-center ">
          <p className="text-xl lg:text-4xl text-gray-300 lg:ml-96 lg:mr-20 mx-10">
            ...
            <br />
            However, curiosity led me down a new path so I&apos;ve recently
            dived into the captivating realm of software development.
            <br />
            Always eager to learn and adapt, keen to grow, learn, and be part of
            impactful projects, I&apos;m on the lookout for opportunities to
            further hone my developer skills.
          </p>
        </div>
      </div>
    </>
